...
Public Class S_01_01003        
    Inherits XL.DB.Utils.BaseService

    Public Shared Function GetInstance() As S_01_01003                                           

        Dim result As S_01_01003                                                                 
        If MyPosXAuto.Decls.CURRENT_DB_TYPE = XL.DB.DBDecl.DBType.Remoting Then

            result = CType(Activator.GetObject(GetType(S_01_01003), _                            
                String.Format("tcp://{0}/S_01_01003.remote", _                                
    ...
    Public Function ServLoadTemplateInfoByCode( _
        ByVal valTemplateCode As String, _
        ByRef refTemplateRowSE As MyPosXAuto.FTs.FT_T_MP_SALE_TEMPLATERowSEntity _
        ) As String
        ...
        Try
            Dim templateConditions As New MyPosXAuto.Facade.AfBizManage.ConditionOfT_MP_SALE_TEMPLATE(XL.DB.Utils.ConditionBuilder.LogicOperators.Logic_Or)
            templateConditions.Add(MyPosXAuto.Facade.AfBizManage.T_MP_SALE_TEMPLATEColumns.TEMPLATE_CODEColumn, "=", valTemplateCode)
            templateConditions.Add(MyPosXAuto.Facade.AfBizManage.T_MP_SALE_TEMPLATEColumns.TEMPLATE_NAMEColumn, "=", valTemplateCode)

            MyPosXAuto.Facade.AfBizManage.FillT_MP_SALE_TEMPLATERowSEntity(refTemplateRowSE, templateConditions)

            If IsDBNull(refTemplateRowSE) = True Then
    ...
    Public Function ServLoadWareInfoByCode( _
        ...
        Try
            ...
            Dim wareConditions As New MyPosXAuto.Facade.AfBizMaster.ConditionOfM_MP_WARE(XL.DB.Utils.ConditionBuilder.LogicOperators.Logic_Or)
            wareConditions.Add(MyPosXAuto.Facade.AfBizMaster.M_MP_WAREColumns.WARE_CODEColumn, "=", valWareCode)
            wareConditions.Add(MyPosXAuto.Facade.AfBizMaster.M_MP_WAREColumns.WARE_NAMEColumn, "=", valWareCode)

            MyPosXAuto.Facade.AfBizMaster.FillM_MP_WARERowSEntity(refWareRowSE, wareConditions)

            If IsDBNull(refWareRowSE) = True Then
                Return MyPosXService.Decls.MSG_ALERT_00008
            End If
