...
Public Class S_01_00901        
    Inherits XL.DB.Utils.BaseService

    Public Shared Function GetInstance() As S_01_00901                                           

        Dim result As S_01_00901                                                                 
        If MyPosXAuto.Decls.CURRENT_DB_TYPE = XL.DB.DBDecl.DBType.Remoting AndAlso CommDecl.SYSTEM_IS_ONLINE Then

            result = CType(Activator.GetObject(GetType(S_01_00901), _
                String.Format("tcp://{0}/S_01_00901.remote", _
