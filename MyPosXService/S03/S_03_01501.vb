...
Public Class S_03_01501        
    Inherits XL.DB.Utils.BaseService

    Public Shared Function GetInstance() As S_03_01501                                           

        Dim result As S_03_01501                                                                 
        If MyPosXAuto.Decls.CURRENT_DB_TYPE = XL.DB.DBDecl.DBType.Remoting Then

            Try

                result = CType(Activator.GetObject(GetType(S_03_01501), _                            
                    String.Format("tcp://{0}/S_03_01501.remote", _                                
