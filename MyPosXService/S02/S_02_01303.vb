...
Public Class S_02_01303        
    Inherits XL.DB.Utils.BaseService

    Public Shared Function GetInstance() As S_02_01303                                           

        Dim result As S_02_01303                                                                 
        If MyPosXAuto.Decls.CURRENT_DB_TYPE = XL.DB.DBDecl.DBType.Remoting Then

            Try

                result = CType(Activator.GetObject(GetType(S_02_01303), _                            
                    String.Format("tcp://{0}/S_02_01303.remote", _                                
