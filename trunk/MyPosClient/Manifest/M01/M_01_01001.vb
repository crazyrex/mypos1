...
Namespace Manifest
    ...
    Partial Public Class M_01_01001
...
#Region"Prerequested Inits"
        ...
        '数据列表变量
        Public SVFT_BINDING_LIST As New MyPosXAuto.FTs.FT_T_MP_SALE_TEMPLATE
        'Public SVFT_CHOOSE_XXX_LIST As New XAuto.FTs.FT_

        Public SVFR_SELECTING_ROW As MyPosXAuto.FTs.FT_T_MP_SALE_TEMPLATERow
        ...
        Public LAUNCH_CONDITION As MyPosXService.S_01_01001.LCs

        Public Overrides Sub SetLC(ByVal LCName As String)

            Me._launchCondition = LCName
            Me.LAUNCH_CONDITION = CType(System.Enum.Parse(GetType(MyPosXService.S_01_01001.LCs), LCName), MyPosXService.S_01_01001.LCs)

        End Sub

        Public Sub InvokeBizRequest(ByVal affair As Business.B_01_01001.Affairs, ByVal sychronized As Boolean)

            Me._bizAgent.DoRequest(affair, sychronized)

        End Sub

        Private WithEvents _bizAgent As Business.B_01_01001
        ...
        Public Sub New(ByVal transactRequestHandle As TransactRequest, ByVal formID As Integer)
            ...
            Me.InitializeMe(New Business.B_01_01001(Me), "基本信息", "优惠活动折扣模板", False)
            Me._bizAgent = CType(Me.BizAgent, Business.B_01_01001)
...
#Region "Basic overrides"
        ...
        Protected Overrides Sub IA_InitAfterRC()
            ...
            Select Case Me.LAUNCH_CONDITION
                Case MyPosXService.S_01_01001.LCs.Choose
            ...
            Me._bizAgent.DoRequest(Business.B_01_01001.Affairs.InitDisplay, False)
        ...
        Public Overrides Sub IA_RespDialog(ByVal responseTitle As String, ByVal popupForm As XL.Win.Component.BaseForm)
            ...
            Select Case responseTitle
                ...
                Case "TbActionRevise"
                    Me._bizAgent.DoRequest(Business.B_01_01001.Affairs.UpdateSelectingRow, False)
        ...
        Public Overrides Sub UpdateDisplay()
            ...
            Me._bizAgent.DoRequest(Business.B_01_01001.Affairs.LoadList, False)
...
#Region "Event Processes"
        Private Sub _bizAgent_Responded(ByVal responseResult As XL.Win.Component.BaseAgent.AgentResponse) Handles _bizAgent.Responded
            ...
            Select Case Me._bizAgent.AffairOf(responseResult.ResponseTitle)
                ...
                Case Business.B_01_01001.Affairs.LoadList
                    Me.DoPrivateUpdateSelectingRow()
                    Me.GridView_SaleTemplate.BestFitColumns()
...
#Region "ToolStrip Actions"
        ...
        Private Sub TbActionCreate()
            ...
            Dim inputForm As New M_01_01002(Me.TransactRequestHandle, Me.FormID)
        ...
        Private Sub TbActionChoose()
            ...
            If Me.LAUNCH_CONDITION <> MyPosXService.S_01_01001.LCs.Choose Then
                Return
            End If
        ...
        Private Sub TbActionRevise()
            ...
            Dim inputForm As New M_01_01002(Me.TransactRequestHandle, Me.FormID)
            inputForm.SV_REVISE_TEMPLATE_ID = Me.SVFR_SELECTING_ROW.TEMPLATE_ID
        ...
        Private Sub TbActionDelete()
            ...
            Me._bizAgent.DoRequest(Business.B_01_01001.Affairs.DeleteInfo, False)
        End Sub
...
#Region"Private Methods"
        ...
        Private Sub DoPrivateUpdateSelectingRow()
            ...
            If Me.GridView_SaleTemplate.RowCount > 0 Then
                Me.SVFR_SELECTING_ROW = _
                    CType(Me.GridView_SaleTemplate.GetDataRow( _
                        Me.GridView_SaleTemplate.FocusedRowHandle),  _
                        MyPosXAuto.FTs.FT_T_MP_SALE_TEMPLATERow)
...
#End Region
        ...
        Private Sub GridView_SaleTemplate_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView_SaleTemplate.DoubleClick
            If Me.LAUNCH_CONDITION = MyPosXService.S_01_01001.LCs.Choose Then
                Me.TbActionChoose()
            Else
                Me.TbActionRevise()
        ...
        Private Sub GridView_SaleTemplate_FocusedRowChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs) Handles GridView_SaleTemplate.FocusedRowChanged
            Me.DoPrivateUpdateSelectingRow()
        End Sub
        ...
        Private Sub TextEdit_Search_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextEdit_Search.KeyDown
            If e.KeyCode = Keys.Enter Then
                WinTK.SearchGridViewText(Me.GridView_SaleTemplate, Me.TextEdit_Search.Text, True)
            End If
        End Sub
    End Class
