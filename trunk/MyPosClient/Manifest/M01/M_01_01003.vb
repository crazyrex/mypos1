...
Namespace Manifest
    ...
    Partial Public Class M_01_01003
...
#Region"Prerequested Inits"
        ...
        Public LAUNCH_CONDITION As MyPosXService.S_01_01003.LCs

        Public Overrides Sub SetLC(ByVal LCName As String)

            Me._launchCondition = LCName
            Me.LAUNCH_CONDITION = CType(System.Enum.Parse(GetType(MyPosXService.S_01_01003.LCs), LCName), MyPosXService.S_01_01003.LCs)

        End Sub

        Public Sub InvokeBizRequest(ByVal affair As Business.B_01_01003.Affairs, ByVal sychronized As Boolean)

            Me._bizAgent.DoRequest(affair, sychronized)

        End Sub

        Private WithEvents _bizAgent As Business.B_01_01003
        ...
        Public Sub New(ByVal transactRequestHandle As TransactRequest, ByVal formID As Integer)
            ...
            Me.InitializeMe(New Business.B_01_01003(Me), "基本信息", "折扣模板货品明细输入", False)
            Me._bizAgent = CType(Me.BizAgent, Business.B_01_01003)
...
#Region "Basic overrides"
        ...
        Protected Overrides Sub IA_InitBeforeRC()
            ...
            Me.SetKeyJumpCycle(Keys.Enter, True, _
                 Me.ButtonEdit_TemplateCode, _
                 Me.ButtonEdit_WareCode, _
                 Me.LookUpEdit_DiscountType, _
                 Me.CalcEdit_DisCountAmount)
            ...
            Me.FormInputGuarder.SetValidate(Me.ButtonEdit_WareCode, InputGuarder.ValidateClassify.Required, Nothing)
            Me.FormInputGuarder.SetValidate(Me.LookUpEdit_DiscountType, InputGuarder.ValidateClassify.Required, Nothing)

            Me.FormInputGuarder.SetInputLinkedLabel(Me.ButtonEdit_TemplateCode, Me.Label_TemplateName, Me.Label_TemplateID)
            Me.FormInputGuarder.SetInputLinkedLabel(Me.ButtonEdit_WareCode, Me.Label_WareName, Me.Label_WareID)
        ...
        Protected Overrides Sub IA_InitAfterRC()
            ...
            Me._bizAgent.DoRequest(Business.B_01_01003.Affairs.InitDisplay, False)
        ...
        Protected Overrides Sub IA_ClearContent(Optional ByVal clearFields As Boolean = False)
            ...
            Me.ButtonEdit_TemplateCode.Select()
        ...
        Public Overrides Sub IA_RespDialog(ByVal responseTitle As String, ByVal popupForm As XL.Win.Component.BaseForm)
            ...
            Select Case responseTitle
                ...
                Case "ButtonEdit_TemplateCode_ButtonClick"
                    Dim chooseForm As M_01_01001 = CType(popupForm, M_01_01001)
                    Me.ButtonEdit_TemplateCode.Text = chooseForm.SVFR_SELECTING_ROW.TEMPLATE_CODE
                    Me.Label_TemplateName.Text = chooseForm.SVFR_SELECTING_ROW.TEMPLATE_NAME
                    Me.Label_TemplateID.Text = chooseForm.SVFR_SELECTING_ROW.TEMPLATE_ID


                Case "ButtonEdit_WareCode_ButtonClick"
                    Dim choosenForm As M_01_00201 = CType(popupForm, M_01_00201)
                    Me.ButtonEdit_WareCode.Text = choosenForm.SVFR_SELECTING_WARE_ROW.WARE_CODE
                    Me.Label_WareName.Text = choosenForm.SVFR_SELECTING_WARE_ROW.WARE_NAME
                    Me.Label_WareID.Text = choosenForm.SVFR_SELECTING_WARE_ROW.WARE_ID
        ...
        Public Overrides Function SaveInfo(ByVal doConfirm As Boolean) As Boolean
            ...
            Me._bizAgent.DoRequest(Business.B_01_01003.Affairs.SaveInfo, False)
        ...
        Public Overrides Sub UpdateDisplay()
            ...
            Me._bizAgent.DoRequest(Business.B_01_01003.Affairs.LoadInfo, False)
...
#Region "Event Processes"
        Private Sub _bizAgent_Responded(ByVal responseResult As XL.Win.Component.BaseAgent.AgentResponse) Handles _bizAgent.Responded
            ...
            Select Case Me._bizAgent.AffairOf(responseResult.ResponseTitle)
                ...
                Case Business.B_01_01003.Affairs.SaveInfo
...
#End Region
        ...
        Private Sub ButtonEdit_TemplateCode_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles ButtonEdit_TemplateCode.ButtonClick
            Dim inputForm As New M_01_01001(Me.TransactRequestHandle, Me.FormID)
            inputForm.LAUNCH_CONDITION = MyPosXService.S_01_01001.LCs.Choose
            Me.PopupForm(inputForm, "ButtonEdit_TemplateCode_ButtonClick", False)
        End Sub

        Private Sub ButtonEdit_TemplateCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles ButtonEdit_TemplateCode.KeyDown
            If e.KeyCode = Keys.Enter Then
                Me._bizAgent.DoRequest(Business.B_01_01003.Affairs.LoadTemplateInfoByCode, False)
            End If
        ...
        Private Sub ButtonEdit_WareCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles ButtonEdit_WareCode.KeyDown
            If e.KeyCode = Keys.Enter Then
                Me._bizAgent.DoRequest(Business.B_01_01003.Affairs.LoadWareInfoByCode, False)
            End If
        End Sub
    End Class
