...
Namespace Manifest
    ...
    Partial Public Class M_01_00805
...
#Region"Prerequested Inits"
        ...
        Public LAUNCH_CONDITION As MyPosXService.S_01_00805.LCs

        Public Overrides Sub SetLC(LCName As String)

            Me._launchCondition = LCName
            Me.LAUNCH_CONDITION = CType(System.Enum.Parse(GetType(MyPosXService.S_01_00805.LCs), LCName), MyPosXService.S_01_00805.LCs)

        End Sub

        Public Sub InvokeBizRequest(ByVal affair As Business.B_01_00805.Affairs, ByVal sychronized As Boolean)

            Me._bizAgent.DoRequest(affair, sychronized)

        End Sub

        Private WithEvents _bizAgent As Business.B_01_00805
        ...
        Public Sub New(ByVal transactRequestHandle As TransactRequest, ByVal formID As Integer)
            ...
            Me.InitializeMe(New Business.B_01_00805(Me), "客户信息","客户信息群发",False)
            Me._bizAgent = CType(Me.BizAgent, Business.B_01_00805)
...
#Region"Basic overrides"
        ...
        Protected Overrides Sub IA_InitBeforeRC()
            ...
            Me.SetToolStripButtonTransactionHandle(Me.ToolStripButton_Send, AddressOf Me.TbActionSend)
        ...
        Protected Overrides Sub IA_InitAfterRC()
            ...
            Me._bizAgent.DoRequest(Business.B_01_00805.Affairs.InitDisplay, False)
        ...
        Public Overrides Sub IA_RespDialog(ByVal responseTitle As String, ByVal popupForm As XL.Win.Component.BaseForm)
            ...
            Select Case responseTitle
                ...
                'Case "TbActionReport"                                                                                
                    ...
                    '            Case XService.Decls.RPT_NAME_0002                                                      
...
#Region"Event Processes"
        ...
        '        Return                                                  
        '    End If                                                      
        '    If Me.LAUNCH_CONDITION = XService.S_0X_00X01.LCs.Choose Then
        '        Me.TbActionChoose()                                     
        '    Else                                                        
        '        Me.TbActionRevise()                                     
        '    End If                                                      
