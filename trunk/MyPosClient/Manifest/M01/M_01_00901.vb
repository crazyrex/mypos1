...
Namespace Manifest
    ...
    Partial Public Class M_01_00901
...
#Region"Prerequested Inits"
        ...
        '数据列表变量
        Public SVFT_BINDING_LIST As New MyPosXAuto.FTs.FT_T_MP_SALE_AFFAIR
        'Public SVFT_CHOOSE_XXX_LIST As New XAuto.FTs.FT_

        Public SVFR_SELECTING_ROW As MyPosXAuto.FTs.FT_T_MP_SALE_AFFAIRRow
        ...
        Public LAUNCH_CONDITION As MyPosXService.S_01_00901.LCs

        Public Overrides Sub SetLC(ByVal LCName As String)

            Me._launchCondition = LCName
            Me.LAUNCH_CONDITION = CType(System.Enum.Parse(GetType(MyPosXService.S_01_00901.LCs), LCName), MyPosXService.S_01_00901.LCs)

        End Sub

        Public Sub InvokeBizRequest(ByVal affair As Business.B_01_00901.Affairs, ByVal sychronized As Boolean)

            Me._bizAgent.DoRequest(affair, sychronized)

        End Sub

        Private WithEvents _bizAgent As Business.B_01_00901
        ...
        Public Sub New(ByVal transactRequestHandle As TransactRequest, ByVal formID As Integer)
            ...
            Me.InitializeMe(New Business.B_01_00901(Me), "基本信息", "优惠活动", False)
            Me._bizAgent = CType(Me.BizAgent, Business.B_01_00901)
...
#Region "Basic overrides"
        ...
        Protected Overrides Sub IA_InitAfterRC()
            ...
            Me._bizAgent.DoRequest(Business.B_01_00901.Affairs.InitDisplay, False)
        ...
        Public Overrides Sub IA_RespDialog(ByVal responseTitle As String, ByVal popupForm As XL.Win.Component.BaseForm)
            ...
            Select Case responseTitle
                ...
                Case "TbActionRevise"
                    Me._bizAgent.DoRequest(Business.B_01_00901.Affairs.UpdateSelectingRow, False)
        ...
        Public Overrides Sub UpdateDisplay()
            ...
            Me._bizAgent.DoRequest(Business.B_01_00901.Affairs.LoadList, False)
...
#Region "ToolStrip Actions"
        ...
        Private Sub TbActionCreate()
            ...
            Dim inputForm As New M_01_00902(Me.TransactRequestHandle, Me.FormID)
        ...
        Private Sub TbActionRevise()
            ...
            Dim inputForm As New M_01_00902(Me.TransactRequestHandle, Me.FormID)
            inputForm.SV_REVISING_AFFAIR_ID = Me.SVFR_SELECTING_ROW.AFFAIR_ID
        ...
        Private Sub TbActionDelete()
            ...
            Me._bizAgent.DoRequest(Business.B_01_00901.Affairs.DeleteInfo, True)
        End Sub
...
#Region"Private Methods"
        ...
        Private Sub DoPrivateUpdateSelectingRow()
            ...
            If Me.GridView_SaleAffair.RowCount > 0 Then
                Me.SVFR_SELECTING_ROW = _
                    CType(Me.GridView_SaleAffair.GetDataRow( _
                        Me.GridView_SaleAffair.FocusedRowHandle),  _
                        MyPosXAuto.FTs.FT_T_MP_SALE_AFFAIRRow)
...
#End Region
        ...
        Private Sub TextEdit_Search_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextEdit_Search.KeyDown
            If e.KeyCode = Keys.Enter Then
                WinTK.SearchGridViewText(Me.GridView_SaleAffair, Me.TextEdit_Search.Text, True)
            End If
        End Sub

        Private Sub GridView_SaleAffair_FocusedRowChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs) Handles GridView_SaleAffair.FocusedRowChanged
            Me.DoPrivateUpdateSelectingRow()
        End Sub
    End Class
