...
Namespace Manifest
    ...
    Partial Public Class M_03_01601
...
#Region"Prerequested Inits"
        ...
        '数据列表变量
        Public SVFT_BINDING_LIST As New MyPosXAuto.FTs.FT_MV_MP_SINGLE_RELIEF_TURNOVER
        'Public SVFT_CHOOSE_XXX_LIST As New XAuto.FTs.FT_

        Public SVFR_SELECTING_ROW As MyPosXAuto.FTs.FT_MV_MP_SINGLE_RELIEF_TURNOVERRow
        ...
        Public LAUNCH_CONDITION As MyPosXService.S_03_01601.LCs

        Public Overrides Sub SetLC(LCName As String)

            Me._launchCondition = LCName
            Me.LAUNCH_CONDITION = CType(System.Enum.Parse(GetType(MyPosXService.S_03_01601.LCs), LCName), MyPosXService.S_03_01601.LCs)

        End Sub

        Public Sub InvokeBizRequest(ByVal affair As Business.B_03_01601.Affairs, ByVal sychronized As Boolean)

            Me._bizAgent.DoRequest(affair, sychronized)

        End Sub

        Private WithEvents _bizAgent As Business.B_03_01601
        ...
        Public Sub New(ByVal transactRequestHandle As TransactRequest, ByVal formID As Integer)
            ...
            Me.InitializeMe(New Business.B_03_01601(Me), "查询","转移移动单据成单警告",False)
            Me._bizAgent = CType(Me.BizAgent, Business.B_03_01601)
...
#Region"Basic overrides"
        ...
        Protected Overrides Sub IA_InitAfterRC()
            ...
            Me._bizAgent.DoRequest(Business.B_03_01601.Affairs.InitDisplay, False)
        ...
        Public Overrides Sub UpdateDisplay()
            ...
            Me._bizAgent.DoRequest(Business.B_03_01601.Affairs.LoadList, False)
...
#Region"Event Processes"
        Private Sub _bizAgent_Responded(ByVal responseResult As XL.Win.Component.BaseAgent.AgentResponse) Handles _bizAgent.Responded
            ...
            Select Case Me._bizAgent.AffairOf(responseResult.ResponseTitle)
                ...
                Case Business.B_03_01601.Affairs.LoadList
                    Me.DoPrivateUpdateSelectingRow()
                    Me.GridView_SingleReliefTurnouerList.BestFitColumns()
...
#End Region
        ...
        Private Sub TextEdit_Search_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextEdit_Search.KeyDown
            If e.KeyCode = Keys.Enter Then
                WinTK.SearchGridViewText(Me.GridView_SingleReliefTurnouerList, Me.TextEdit_Search.Text, True)
            End If
        End Sub
    End Class
