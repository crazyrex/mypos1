...
Namespace Manifest
    ...
    Partial Public Class M_03_01501
...
#Region"Prerequested Inits"
        ...
        Public LAUNCH_CONDITION As MyPosXService.S_03_01501.LCs

        Public Overrides Sub SetLC(LCName As String)

            Me._launchCondition = LCName
            Me.LAUNCH_CONDITION = CType(System.Enum.Parse(GetType(MyPosXService.S_03_01501.LCs), LCName), MyPosXService.S_03_01501.LCs)

        End Sub

        Public Sub InvokeBizRequest(ByVal affair As Business.B_03_01501.Affairs, ByVal sychronized As Boolean)

            Me._bizAgent.DoRequest(affair, sychronized)

        End Sub

        Private WithEvents _bizAgent As Business.B_03_01501
        ...
        Public Sub New(ByVal transactRequestHandle As TransactRequest, ByVal formID As Integer)
            ...
            Me.InitializeMe(New Business.B_03_01501(Me), "查询","积分换物期间汇总",False)
            Me._bizAgent = CType(Me.BizAgent, Business.B_03_01501)
...
#Region"Basic overrides"
        ...
        Protected Overrides Sub IA_InitAfterRC()
            ...
            Me._bizAgent.DoRequest(Business.B_03_01501.Affairs.InitDisplay, False)
