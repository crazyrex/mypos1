...
Namespace Manifest
    ...
    Partial Public Class M_03_01401
...
#Region"Prerequested Inits"
        ...
        '数据列表变量
        Public SVFT_BINDING_LIST As New MyPosXAuto.FTs.FT_MV_MP_POS_WARE_AMOUNT_OF_UNIT_COST_ORIGION_PRICE
        'Public SVFT_CHOOSE_XXX_LIST As New XAuto.FTs.FT_

        Public SVFR_SELECTING_ROW As MyPosXAuto.FTs.FT_MV_MP_POS_WARE_AMOUNT_OF_UNIT_COST_ORIGION_PRICERow
        ...
        Public LAUNCH_CONDITION As MyPosXService.S_03_01401.LCs

        Public Overrides Sub SetLC(LCName As String)

            Me._launchCondition = LCName
            Me.LAUNCH_CONDITION = CType(System.Enum.Parse(GetType(MyPosXService.S_03_01401.LCs), LCName), MyPosXService.S_03_01401.LCs)

        End Sub

        Public Sub InvokeBizRequest(ByVal affair As Business.B_03_01401.Affairs, ByVal sychronized As Boolean)

            Me._bizAgent.DoRequest(affair, sychronized)

        End Sub

        Private WithEvents _bizAgent As Business.B_03_01401
        ...
        Public Sub New(ByVal transactRequestHandle As TransactRequest, ByVal formID As Integer)
            ...
            Me.InitializeMe(New Business.B_03_01401(Me), "查询","地点成本原价区分在库",False)
            Me._bizAgent = CType(Me.BizAgent, Business.B_03_01401)
...
#Region"Basic overrides"
        ...
        Protected Overrides Sub IA_InitAfterRC()
            ...
            Me._bizAgent.DoRequest(Business.B_03_01401.Affairs.InitDisplay, False)
        ...
        Public Overrides Sub IA_RespDialog(ByVal responseTitle As String, ByVal popupForm As XL.Win.Component.BaseForm)
            ...
            Select Case responseTitle
                ...
                Case "ButtonEdit_WareCode_ButtonClick"
                    ...
                    Me.Label_WareName.Text = chooseForm.SVFR_SELECTING_WARE_ROW.WARE_NAME
...
#End Region
        ...
        Private Sub ButtonEdit_WareCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles ButtonEdit_WareCode.KeyDown
            If e.KeyCode = Keys.Enter Then
                Me._bizAgent.DoRequest(Business.B_03_01401.Affairs.LoadPosInfoByCode, False)
            End If
        End Sub
    End Class
