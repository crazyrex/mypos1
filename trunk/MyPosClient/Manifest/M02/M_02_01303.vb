...
Namespace Manifest
    ...
    Partial Public Class M_02_01303
...
#Region"Prerequested Inits"
        ...
        Public LAUNCH_CONDITION As MyPosXService.S_02_01303.LCs

        Public Overrides Sub SetLC(LCName As String)

            Me._launchCondition = LCName
            Me.LAUNCH_CONDITION = CType(System.Enum.Parse(GetType(MyPosXService.S_02_01303.LCs), LCName), MyPosXService.S_02_01303.LCs)

        End Sub

        Public Sub InvokeBizRequest(ByVal affair As Business.B_02_01303.Affairs, ByVal sychronized As Boolean)

            Me._bizAgent.DoRequest(affair, sychronized)

        End Sub

        Private WithEvents _bizAgent As Business.B_02_01303
        ...
        Public Sub New(ByVal transactRequestHandle As TransactRequest, ByVal formID As Integer)
            ...
            Me.InitializeMe(New Business.B_02_01303(Me), "业务操作","报价单Bom编辑",False)
            Me._bizAgent = CType(Me.BizAgent, Business.B_02_01303)
...
#Region"Basic overrides"
        ...
        Protected Overrides Sub IA_InitAfterRC()
            ...
            Me._bizAgent.DoRequest(Business.B_02_01303.Affairs.InitDisplay, False)
