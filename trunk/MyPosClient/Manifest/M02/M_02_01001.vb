        ...
        Public Overrides Sub IA_RespDialog(ByVal responseTitle As String, ByVal popupForm As XL.Win.Component.BaseForm)
            ...
            Select Case responseTitle
                ...
                Case "Case Business.B_02_01001.Affairs.SaveInfo"
                    ...
                    Dim shareCondition As New MyPosXAuto.Facade.AfBizTurnover.ConditionOfH_MP_TURNOVER_SHARE_DTL(XL.DB.Utils.Condition.LogicOperators.Logic_And)
                    shareCondition.Add(MyPosXAuto.Facade.AfBizTurnover.H_MP_TURNOVER_SHARE_DTLColumns.TURNOVER_IDColumn, "=", Me.SV_EDITING_TURNOVER_ID)
