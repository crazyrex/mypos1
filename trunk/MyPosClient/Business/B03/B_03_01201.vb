...
#Region"Prerequested Inits"
        ...
        '本代理所对应的表现层实例
        '
        Private _manifest As Manifest.M_03_01201     
        Private _service As MyPosXService.S_03_01201     
        ...
        Public Sub New(ByVal theManifest As XL.Win.Component.BaseForm)
            ...
            Me._manifest = CType(theManifest, Manifest.M_03_01201)

            
            Try

                Me._service = MyPosXService.S_03_01201.GetInstance()
...
#Region "Transaction Modules"
        ...
        Private Function DoLoadList() As String
            ...
            Try
                ...
                Dim clientPointIOConditions As New MyPosXAuto.Facade.AfBizManage.ConditionOfH_MP_CLIENT_POINT_IO(XL.DB.Utils.Condition.LogicOperators.Logic_And)
                If Me._manifest.DateEdit_Begin.Text.Length > 0 Then
                ...
                End If
                If Me._manifest.DateEdit_End.Text.Length > 0 Then
                ...
                Me._manifest.GridControl_ClientPointIO.DataSource = Me._manifest.SVFT_BINDING_LIST
        ...
        Private Function DoLoadClientInfoByCode() As String
            ...
            Try
                ...
                Dim servResult As String = _
                    Me._service.ServLoadClientInfoByCode( _
                        Me._manifest.ButtonEdit_ClientCode.Text, _
                        clientRowSE)
