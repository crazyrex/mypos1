...
#Region"Prerequested Inits"
        ...
        '本代理所对应的表现层实例
        '
        Private _manifest As Manifest.M_03_01501     
        Private _service As MyPosXService.S_03_01501     
        ...
        Public Sub New(ByVal theManifest As XL.Win.Component.BaseForm)
            ...
            Me._manifest = CType(theManifest, Manifest.M_03_01501)     

            Try                                                        
                                                               
                Me._service = MyPosXService.S_03_01501.GetInstance()     
