...
#Region"Prerequested Inits"
        ...
        '本代理所对应的表现层实例
        '
        Private _manifest As Manifest.M_01_00805     
        Private _service As MyPosXService.S_01_00805
        ...
        Public Sub New(ByVal theManifest As XL.Win.Component.BaseForm)
            ...
            Me._manifest = CType(theManifest, Manifest.M_01_00805)     

            Try                                                        
                                                               
                Me._service = MyPosXService.S_01_00805.GetInstance()
...
#Region"Transaction Modules"
        ...
        Private Function DoInitDisplay() As String
            ...
            Try
                ...
                'Dim choosePurchaseWayList As New XAuto.FTs.FT_CIV_PURCHASE_WAY                                       
                'Dim chooseAssetAbsentTypeList As New XAuto.FTs.FT_CIV_ASSET_ABSENT_TYPE                              
                'Dim chooseAssetConformationList As New XAuto.FTs.FT_CIV_ASSET_CONFORMATION                           
                'Dim chooseEliminateWayList As New XAuto.FTs.FT_CIV_ELIMINATE_WAY                                     
                'Dim chooseInAccountCredenceTextList As New XAuto.FTs.FT_CIV_IN_ACCOUNT_CREDENCE_TEXT                 
                '                                                                                                     
                ...
                'Me._manifest.LookUpEdit_EliminateWay.EditValue = XService.Decls.DEFAULT_CI_ELIMINATE_WAY_VALUE_NONE  
                '                                                                                                     
                ...
                'Me._manifest.SV_RPTOPT_LABEL = New XForm.ReportOption(XService.Decls.RPT_NAME_0001, XForm.ReportOption.PrintType.Label, True)
...
'Code Samples Below ------------------------
        ...
        '        End If                                                                                                                 
        '                                                                                                                               
        '        Dim SSCondition As New XAuto.Facade.AfBizMaster.ConditionOfM_SSS(XL.DB.Utils.Condition.LogicOperators.Logic_And)
