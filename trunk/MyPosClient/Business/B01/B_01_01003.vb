...
#Region"Prerequested Inits"
        ...
        '本代理所对应的表现层实例
        '
        Private _manifest As Manifest.M_01_01003     
        Private _service As MyPosXService.S_01_01003
        ...
        Public Sub New(ByVal theManifest As XL.Win.Component.BaseForm)
            ...
            Me._manifest = CType(theManifest, Manifest.M_01_01003)

            Try

                Me._service = MyPosXService.S_01_01003.GetInstance()
        ...
        Public Sub DoRequest(ByVal affair As Affairs, ByVal sychronized As Boolean)
            ...
            Select Case affair
                ...
                Case Affairs.LoadTemplateInfoByCode

                    '
                    '取到处理函数的结果，传入返回给Manifest的AgentResponse包
                    '-------------------------------------------------------------------
                    functionHandle = New XL.Win.StringFunctionTransaction(AddressOf Me.DoLoadTemplateInfoByCode)
...
#Region "Transaction Modules"
        ...
        Private Function DoInitDisplay() As String
            ...
            Try
                ...
                Me._manifest.LookUpEdit_DiscountType.Properties.DataSource = chooseDiscountTypeList
        ...
        Private Function DoLoadInfo() As String
            ...
            Try
                ...
                Me._manifest.LookUpEdit_DiscountType.EditValue = Me._manifest.SVFR_EDITING_SALE_TEMPLATE_WARE_ROW.DISCOUNT_TYPE
                Me._manifest.CalcEdit_DisCountAmount.Value = Me._manifest.SVFR_EDITING_SALE_TEMPLATE_WARE_ROW.DISCOUNT_AMOUNT
                ...
                templateConditions.Add(MyPosXAuto.Facade.AfBizManage.T_MP_SALE_TEMPLATEColumns.TEMPLATE_IDColumn, "=", Me._manifest.SVFR_EDITING_SALE_TEMPLATE_WARE_ROW.TEMPLATE_ID)
                ...
                Dim wareConditions As New MyPosXAuto.Facade.AfBizMaster.ConditionOfM_MP_WARE(XL.DB.Utils.ConditionBuilder.LogicOperators.Logic_And)
                wareConditions.Add(MyPosXAuto.Facade.AfBizMaster.M_MP_WAREColumns.WARE_IDColumn, "=", Me._manifest.SVFR_EDITING_SALE_TEMPLATE_WARE_ROW.WARE_ID)
                MyPosXAuto.Facade.AfBizMaster.FillM_MP_WARERowSEntity(wareRowSE, wareConditions)
                Me._manifest.ButtonEdit_WareCode.Text = wareRowSE.WARE_CODE
                Me._manifest.Label_WareName.Text = wareRowSE.WARE_NAME
                Me._manifest.Label_WareID.Text = wareRowSE.WARE_ID
        ...
        Private Function DoSaveInfo() As String
            ...
            Try
                ...
                If IsNothing(Me._manifest.SVFR_EDITING_SALE_TEMPLATE_WARE_ROW) = True Then
                    ...
                    saleTemplateWareRow.TEMPLATE_ID = Me._manifest.Label_TemplateID.Text
                    saleTemplateWareRow.WARE_ID = Me._manifest.Label_WareID.Text

                    Return String.Empty

                End If

                Me._manifest.SVFR_EDITING_SALE_TEMPLATE_WARE_ROW.DISCOUNT_AMOUNT = CommTK.FInteger(Me._manifest.CalcEdit_DisCountAmount.Text)
                Me._manifest.SVFR_EDITING_SALE_TEMPLATE_WARE_ROW.DISCOUNT_TYPE = CommTK.FInteger(Me._manifest.LookUpEdit_DiscountType.EditValue)
                Me._manifest.SVFR_EDITING_SALE_TEMPLATE_WARE_ROW.TEMPLATE_ID = Me._manifest.Label_TemplateID.Text
                Me._manifest.SVFR_EDITING_SALE_TEMPLATE_WARE_ROW.WARE_ID = Me._manifest.Label_WareID.Text
        ...
        '''
        '''-------------------------------------------------------------------
        Private Function DoLoadTemplateInfoByCode() As String


            Try
                If Me._manifest.ButtonEdit_TemplateCode.Text.Trim.Length = 0 Then
                    Return String.Empty
                End If
                ...
                Dim servResult As String = _
                    Me._service.ServLoadTemplateInfoByCode( _
        ...
        Private Function DoLoadWareInfoByCode() As String
            ...
            Try
                ...
                Dim servResult As String = _
                    Me._service.ServLoadWareInfoByCode( _
