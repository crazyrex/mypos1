...
Public Class S_03_01601        
    Inherits XL.DB.Utils.BaseService

    Public Shared Function GetInstance() As S_03_01601                                           

        Dim result As S_03_01601                                                                 
        If MyPosXAuto.Decls.CURRENT_DB_TYPE = XL.DB.DBDecl.DBType.Remoting Then

            Try

                result = CType(Activator.GetObject(GetType(S_03_01601), _                            
                    String.Format("tcp://{0}/S_03_01601.remote", _                                
