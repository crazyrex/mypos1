...
Public Class S_02_01302        
    Inherits XL.DB.Utils.BaseService

    Public Shared Function GetInstance() As S_02_01302                                           

        Dim result As S_02_01302                                                                 
        If MyPosXAuto.Decls.CURRENT_DB_TYPE = XL.DB.DBDecl.DBType.Remoting Then

            Try

                result = CType(Activator.GetObject(GetType(S_02_01302), _                            
                    String.Format("tcp://{0}/S_02_01302.remote", _                                
