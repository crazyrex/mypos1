...
Public Class S_02_01301        
    Inherits XL.DB.Utils.BaseService

    Public Shared Function GetInstance() As S_02_01301                                           

        Dim result As S_02_01301                                                                 
        If MyPosXAuto.Decls.CURRENT_DB_TYPE = XL.DB.DBDecl.DBType.Remoting Then

            Try

                result = CType(Activator.GetObject(GetType(S_02_01301), _                            
                    String.Format("tcp://{0}/S_02_01301.remote", _                                
