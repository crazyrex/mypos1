...
Public Class S_02_01201        
    Inherits XL.DB.Utils.BaseService

    Public Shared Function GetInstance() As S_02_01201                                           

        Dim result As S_02_01201                                                                 
        If MyPosXAuto.Decls.CURRENT_DB_TYPE = XL.DB.DBDecl.DBType.Remoting AndAlso CommDecl.SYSTEM_IS_ONLINE Then

            result = CType(Activator.GetObject(GetType(S_02_01201), _
                String.Format("tcp://{0}/S_02_01201.remote", _
