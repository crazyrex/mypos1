...
#Region"Prerequested Inits"
        ...
        '本代理所对应的表现层实例
        '
        Private _manifest As Manifest.M_03_01601     
        Private _service As MyPosXService.S_03_01601     
        ...
        Public Sub New(ByVal theManifest As XL.Win.Component.BaseForm)
            ...
            Me._manifest = CType(theManifest, Manifest.M_03_01601)     

            Try                                                        
                                                               
                Me._service = MyPosXService.S_03_01601.GetInstance()     
...
#Region"Transaction Modules"
        ...
        Private Function DoInitDisplay() As String
            ...
            Try
                ...
                Dim chooseStaffList As New MyPosXAuto.FTs.FT_M_STAFF
                Dim choosePosList As New MyPosXAuto.FTs.FT_M_MP_POS

                MyPosXAuto.Facade.AfBizMaster.FillFT_M_STAFF(Nothing, chooseStaffList)
                MyPosXAuto.Facade.AfBizMaster.FillFT_M_MP_POS(Nothing, choosePosList)

                Me._manifest.RepositoryItemLookUpEdit_StaffID.DataSource = chooseStaffList
                Me._manifest.RepositoryItemLookUpEdit_PosID.DataSource = choosePosList
        ...
        Private Function DoLoadList() As String                                     
            ...
            Try                                                                     
                ...
                Dim singleRelierTurnoverConditions As New MyPosXAuto.Facade.AfMV.ConditionOfMV_MP_SINGLE_RELIEF_TURNOVER(XL.DB.Utils.Condition.LogicOperators.Logic_And)
                singleRelierTurnoverConditions.Add(MyPosXAuto.Facade.AfMV.MV_MP_SINGLE_RELIEF_TURNOVERColumns.TURNOVER_CODEColumn, "=>", CommTK.GetBeginOfDate(Me._manifest.DateEdit_From.DateTime))
                singleRelierTurnoverConditions.Add(MyPosXAuto.Facade.AfMV.MV_MP_SINGLE_RELIEF_TURNOVERColumns.TURNOVER_CODEColumn, "=<", CommTK.GetEndOfDate(Me._manifest.DateEdit_To.DateTime))
                singleRelierTurnoverConditions.Add(MyPosXAuto.Facade.AfMV.MV_MP_SINGLE_RELIEF_TURNOVERColumns.POS_IDColumn, "=", Me._manifest.LookUpEdit_Pos.EditValue)

                MyPosXAuto.Facade.AfMV.FillFT_MV_MP_SINGLE_RELIEF_TURNOVER(singleRelierTurnoverConditions, Me._manifest.SVFT_BINDING_LIST)

                Me._manifest.GridControl_SingleReliefTurnouerList.DataSource = Me._manifest.SVFT_BINDING_LIST
