...
#Region"Prerequested Inits"
        ...
        '本代理所对应的表现层实例
        '
        Private _manifest As Manifest.M_03_01401     
        Private _service As MyPosXService.S_03_01401     
        ...
        Public Sub New(ByVal theManifest As XL.Win.Component.BaseForm)
            ...
            Me._manifest = CType(theManifest, Manifest.M_03_01401)

            Try

                Me._service = MyPosXService.S_03_01401.GetInstance()
        ...
        Public Sub DoRequest(ByVal affair As Affairs, ByVal sychronized As Boolean)
            ...
            Select Case affair
                ...
                Case Affairs.LoadPosInfoByCode

                    '
                    '取到处理函数的结果，传入返回给Manifest的AgentResponse包
                    '-------------------------------------------------------------------
                    functionHandle = New XL.Win.StringFunctionTransaction(AddressOf Me.DoLoadPosInfoByCode)
...
#Region "Transaction Modules"
        ...
        '''
        '''-------------------------------------------------------------------
        Private Function DoLoadPosInfoByCode() As String
            ...
            Try
                ...
                Dim servResult As String = _
                    Me._service.ServLoadPosInfoByCode( _
                ...
                Me._manifest.ButtonEdit_WareCode.Text = posRowSE.POS_CODE
                Me._manifest.Label_WareName.Text = posRowSE.POS_NAME
                Me._manifest.Label_WareID.Text = posRowSE.POS_SET_ID
