...
#Region"Prerequested Inits"
        ...
        '本代理所对应的表现层实例
        '
        Private _manifest As Manifest.M_01_01002     
        Private _service As MyPosXService.S_01_01002
        ...
        Public Sub New(ByVal theManifest As XL.Win.Component.BaseForm)
            ...
            Me._manifest = CType(theManifest, Manifest.M_01_01002)

            Try

                Me._service = MyPosXService.S_01_01002.GetInstance()
...
#Region "Transaction Modules"
        ...
        Private Function DoLoadInfo() As String
            ...
            Try
                ...
                If Me._manifest.SV_REVISE_TEMPLATE_ID.Length = 0 Then
                    Return String.Empty
                End If
                ...
                Dim servResult As String = _
                    Me._service.ServLoadInfo( _
                        Me._manifest.SV_REVISE_TEMPLATE_ID, _
                        templateRowSE, _
                ...
                Me._manifest.TextEdit_TemplateCode.Text = templateRowSE.TEMPLATE_CODE
            ...
            Try
                ...
                Dim servResult As String = _
                    Me._service.ServSaveInfo( _
                        Me._manifest.SV_REVISE_TEMPLATE_ID, _
                        Me._manifest.TextEdit_TemplateCode.Text, _
                        Me._manifest.TextEdit_TemplateName.Text, _
                        Me._manifest.MemoEdit_Remark.Text, _
                        Me._manifest.SVFT_BINDING_LIST)
