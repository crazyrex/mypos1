...
#Region"Prerequested Inits"
        ...
        '本代理所对应的表现层实例
        '
        Private _manifest As Manifest.M_01_01001     
        Private _service As MyPosXService.S_01_01001
        ...
        Public Sub New(ByVal theManifest As XL.Win.Component.BaseForm)
            ...
            Me._manifest = CType(theManifest, Manifest.M_01_01001)

            Try

                Me._service = MyPosXService.S_01_01001.GetInstance()
...
#Region "Transaction Modules"
        ...
        Private Function DoLoadList() As String
            ...
            Try
                ...
                MyPosXAuto.DataCache.DCHBizManage.OverwriteT_MP_SALE_TEMPLATEFromDB()
                MyPosXAuto.Facade.AfBizManage.FillFT_T_MP_SALE_TEMPLATE(Nothing, Me._manifest.SVFT_BINDING_LIST)

                Me._manifest.GridControl_SaleTemplate.DataSource = Me._manifest.SVFT_BINDING_LIST
        ...
        Private Function DoUpdateSelectingRow() As String
            ...
            Try
                ...
                MyPosXAuto.Facade.AfBizManage.UpdateFT_T_MP_SALE_TEMPLATE_Row(Me._manifest.SVFR_SELECTING_ROW)
                'Dim servResult As String = _
        ...
        Private Function DoDeleteInfo() As String
            ...
            Try
                ...
                MyPosXAuto.Facade.AfBizManage.DeleteT_MP_SALE_TEMPLATEInfo(Me._manifest.SVFR_SELECTING_ROW.TEMPLATE_ID)
