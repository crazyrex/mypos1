...
#Region"Prerequested Inits"
        ...
        '本代理所对应的表现层实例
        '
        Private _manifest As Manifest.M_02_01301     
        Private _service As MyPosXService.S_02_01301     
        ...
        Public Sub New(ByVal theManifest As XL.Win.Component.BaseForm)
            ...
            Me._manifest = CType(theManifest, Manifest.M_02_01301)     

            Try                                                        
                                                               
                Me._service = MyPosXService.S_02_01301.GetInstance()     
...
#Region"Transaction Modules"
        ...
        Private Function DoLoadList() As String                                     
            ...
            Try                                                                     
                ...
                MyPosXAuto.Facade.AfBizManage.FillFT_T_MP_QUOTATION(Nothing, Me._manifest.SVFT_BINDING_LIST)

                Me._manifest.GridControl_Quotation.DataSource = Me._manifest.SVFT_BINDING_LIST
