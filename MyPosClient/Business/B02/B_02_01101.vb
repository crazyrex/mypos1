...
#Region"Prerequested Inits"
        ...
        '本代理所对应的表现层实例
        '
        Private _manifest As Manifest.M_02_01101     
        Private _service As MyPosXService.S_02_01101     
...
#Region "Transaction Modules"
        ...
        Private Function DoPrintPurchaseList() As String
            ...
            Try
                ...
                If Utils.Decls.LOGIN_STAFF_ROW_SE.IsNull = True Then
                    Return String.Empty
                End If
                ...
                report.XrLabel_Operator.Text = String.Format(" <{0}> {1} ", _
                        Utils.Decls.LOGIN_STAFF_ROW_SE.STAFF_CODE, _
                        Utils.Decls.LOGIN_STAFF_ROW_SE.STAFF_NAME)
