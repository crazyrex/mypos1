...
#Region"Prerequested Inits"
        ...
        Public Sub InvokeBizRequest(ByVal affair As Business.B_01_00501.Affairs, ByVal sychronized As Boolean)

            Me._bizAgent.DoRequest(affair, sychronized)

        End Sub

        Private WithEvents _bizAgent As Business.B_01_00501
