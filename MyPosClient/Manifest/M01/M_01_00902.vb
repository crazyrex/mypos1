...
Namespace Manifest
    ...
    Partial Public Class M_01_00902
...
#Region"Prerequested Inits"
        ...
        '-------------------------------------------------------------------
        Public SV_REVISING_AFFAIR_ID As String = String.Empty
        ...
        Public LAUNCH_CONDITION As MyPosXService.S_01_00902.LCs

        Public Overrides Sub SetLC(LCName As String)

            Me._launchCondition = LCName
            Me.LAUNCH_CONDITION = CType(System.Enum.Parse(GetType(MyPosXService.S_01_00902.LCs), LCName), MyPosXService.S_01_00902.LCs)

        End Sub

        Public Sub InvokeBizRequest(ByVal affair As Business.B_01_00902.Affairs, ByVal sychronized As Boolean)

            Me._bizAgent.DoRequest(affair, sychronized)

        End Sub

        Private WithEvents _bizAgent As Business.B_01_00902
        ...
        Public Sub New(ByVal transactRequestHandle As TransactRequest, ByVal formID As Integer)
            ...
            Me.InitializeMe(New Business.B_01_00902(Me), "基本信息","优惠活动输入",False)
            Me._bizAgent = CType(Me.BizAgent, Business.B_01_00902)
...
#Region"Basic overrides"
        ...
        Protected Overrides Sub IA_InitAfterRC()
            ...
            Me._bizAgent.DoRequest(Business.B_01_00902.Affairs.InitDisplay, False)
        ...
        Public Overrides Function SaveInfo(ByVal doConfirm As Boolean) As Boolean
            ...
            Me._bizAgent.DoRequest(Business.B_01_00902.Affairs.SaveInfo, False)
        ...
        Public Overrides Sub UpdateDisplay()
            ...
            Me._bizAgent.DoRequest(Business.B_01_00902.Affairs.LoadInfo, False)
        ...
        Private Sub _bizAgent_Responded(ByVal responseResult As XL.Win.Component.BaseAgent.AgentResponse) Handles _bizAgent.Responded
            ...
            Select Case Me._bizAgent.AffairOf(responseResult.ResponseTitle)
                ...
                Case Business.B_01_00902.Affairs.SaveInfo
                    ...
                    'If Me.SV_REVISING_AFFAIR_ID.Length > 0 Then
                    Me.ResetSaveMode()
                    Me.CloseForm()
                    'Else
                    'Me.IA_ClearContent()
