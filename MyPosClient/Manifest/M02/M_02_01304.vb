...
Namespace Manifest
    ...
    Partial Public Class M_02_01304
...
#Region"Prerequested Inits"
        ...
        Public LAUNCH_CONDITION As MyPosXService.S_02_01304.LCs

        Public Overrides Sub SetLC(LCName As String)

            Me._launchCondition = LCName
            Me.LAUNCH_CONDITION = CType(System.Enum.Parse(GetType(MyPosXService.S_02_01304.LCs), LCName), MyPosXService.S_02_01304.LCs)

        End Sub

        Public Sub InvokeBizRequest(ByVal affair As Business.B_02_01304.Affairs, ByVal sychronized As Boolean)

            Me._bizAgent.DoRequest(affair, sychronized)

        End Sub

        Private WithEvents _bizAgent As Business.B_02_01304
        ...
        Public Sub New(ByVal transactRequestHandle As TransactRequest, ByVal formID As Integer)
            ...
            Me.InitializeMe(New Business.B_02_01304(Me), "业务操作","报价单Bom组件选项",False)
            Me._bizAgent = CType(Me.BizAgent, Business.B_02_01304)
