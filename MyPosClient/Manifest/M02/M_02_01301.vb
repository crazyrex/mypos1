...
Namespace Manifest
    ...
    Partial Public Class M_02_01301
...
#Region"Prerequested Inits"
        ...
        '数据列表变量
        Public SVFT_BINDING_LIST As New MyPosXAuto.FTs.FT_T_MP_QUOTATION
        'Public SVFT_CHOOSE_XXX_LIST As New MyPosXAuto.FTs.FT_

        Public SVFR_SELECTING_ROW As MyPosXAuto.FTs.FT_T_MP_QUOTATIONRow
        ...
        Public LAUNCH_CONDITION As MyPosXService.S_02_01301.LCs

        Public Overrides Sub SetLC(LCName As String)

            Me._launchCondition = LCName
            Me.LAUNCH_CONDITION = CType(System.Enum.Parse(GetType(MyPosXService.S_02_01301.LCs), LCName), MyPosXService.S_02_01301.LCs)

        End Sub

        Public Sub InvokeBizRequest(ByVal affair As Business.B_02_01301.Affairs, ByVal sychronized As Boolean)

            Me._bizAgent.DoRequest(affair, sychronized)

        End Sub

        Private WithEvents _bizAgent As Business.B_02_01301
        ...
        Public Sub New(ByVal transactRequestHandle As TransactRequest, ByVal formID As Integer)
            ...
            Me.InitializeMe(New Business.B_02_01301(Me), "业务操作","报价单管理",False)
            Me._bizAgent = CType(Me.BizAgent, Business.B_02_01301)
...
#Region"Basic overrides"
        ...
        Protected Overrides Sub IA_InitAfterRC()
            ...
            Me._bizAgent.DoRequest(Business.B_02_01301.Affairs.InitDisplay, False)
        ...
        Public Overrides Sub UpdateDisplay()
            ...
            Me._bizAgent.DoRequest(Business.B_02_01301.Affairs.LoadList, False)
...
#Region"Event Processes"
        Private Sub _bizAgent_Responded(ByVal responseResult As XL.Win.Component.BaseAgent.AgentResponse) Handles _bizAgent.Responded
            ...
            Select Case Me._bizAgent.AffairOf(responseResult.ResponseTitle)
                ...
                Case Business.B_02_01301.Affairs.LoadList
                    Me.DoPrivateUpdateSelectingRow()
                    Me.GridView_Quotation.BestFitColumns()
...
#Region"ToolStrip Actions"
        ...
        Private Sub TbActionCreate()
            ...
            Dim inputForm As New M_02_01302(Me.TransactRequestHandle, Me.FormID)
        ...
        Private Sub TbActionRevise()
            Dim inputForm As New M_02_01302(Me.TransactRequestHandle, Me.FormID)
            inputForm.SV_EDITING_QUOTATION_ID = Me.SVFR_SELECTING_ROW.QUOTATION_ID
            Me.PopupForm(inputForm, "TbActionCreate", False)
...
#Region"Private Methods"
        ...
        Private Sub DoPrivateUpdateSelectingRow()
            ...
            If Me.GridView_Quotation.RowCount > 0 Then
                Me.SVFR_SELECTING_ROW = _
                    CType(Me.GridView_Quotation.GetDataRow( _
                        Me.GridView_Quotation.FocusedRowHandle),  _
                        MyPosXAuto.FTs.FT_T_MP_QUOTATIONRow)
...
#End Region
        ...
        Private Sub GridView_Quotation_FocusedRowChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs) Handles GridView_Quotation.FocusedRowChanged
            Me.DoPrivateUpdateSelectingRow()
