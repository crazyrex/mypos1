...
#Region "Shared values"
        ...
        Public SVFR_SELECTING_ROW As MyPosXAuto.FTs.FT_T_MP_QUOTATION_WARE_DTLRow
...
#Region "Basic overrides"
        ...
        Protected Overrides Sub IA_InitBeforeRC()
            ...
            Me.FormInputGuarder.SetValidate(Me.LookUpEdit_TurnoverStyle, InputGuarder.ValidateClassify.Required, Nothing)
            ...
            If Me.GridView_QuotationWareDtl.RowCount > 0 Then
                Me.SVFR_SELECTING_ROW = _
                    CType(Me.GridView_QuotationWareDtl.GetDataRow( _
                        ...
                        MyPosXAuto.FTs.FT_T_MP_QUOTATION_WARE_DTLRow)
