...
Namespace Manifest
    ...
    Partial Public Class M_03_01201
...
#Region"Prerequested Inits"
        ...
        '数据列表变量
        Public SVFT_BINDING_LIST As New MyPosXAuto.FTs.FT_H_MP_CLIENT_POINT_IO
        'Public SVFT_CHOOSE_XXX_LIST As New XAuto.FTs.FT_

        Public SVFR_SELECTING_ROW As MyPosXAuto.FTs.FT_H_MP_CLIENT_POINT_IORow
        ...
        Public LAUNCH_CONDITION As MyPosXService.S_03_01201.LCs

        Public Overrides Sub SetLC(LCName As String)

            Me._launchCondition = LCName
            Me.LAUNCH_CONDITION = CType(System.Enum.Parse(GetType(MyPosXService.S_03_01201.LCs), LCName), MyPosXService.S_03_01201.LCs)

        End Sub

        Public Sub InvokeBizRequest(ByVal affair As Business.B_03_01201.Affairs, ByVal sychronized As Boolean)

            Me._bizAgent.DoRequest(affair, sychronized)

        End Sub

        Private WithEvents _bizAgent As Business.B_03_01201
        ...
        Public Sub New(ByVal transactRequestHandle As TransactRequest, ByVal formID As Integer)
            ...
            Me.InitializeMe(New Business.B_03_01201(Me), "查询","客户点数出入",False)
            Me._bizAgent = CType(Me.BizAgent, Business.B_03_01201)
...
#Region"Basic overrides"
        ...
        Protected Overrides Sub IA_InitBeforeRC()
            ...
            Me.FormInputGuarder.SetInputLinkedLabel(Me.ButtonEdit_ClientCode, Me.Label_ClientName, Me.Label_ClientID)
        ...
        Protected Overrides Sub IA_InitAfterRC()
            ...
            Me._bizAgent.DoRequest(Business.B_03_01201.Affairs.InitDisplay, False)
        ...
        Public Overrides Sub IA_RespDialog(ByVal responseTitle As String, ByVal popupForm As XL.Win.Component.BaseForm)
            ...
            Select Case responseTitle
                ...
                Case "ButtonEdit_ClientCode_ButtonClick"
                    Dim chooseForm As M_01_00801 = CType(popupForm, M_01_00801)
                    Me.ButtonEdit_ClientCode.Text = chooseForm.SVFR_SELECTING_CLIENT_ROW.CLIENT_CODE
                    Me.Label_ClientName.Text = chooseForm.SVFR_SELECTING_CLIENT_ROW.CLIENT_NAME
                    Me.Label_ClientID.Text = chooseForm.SVFR_SELECTING_CLIENT_ROW.CLIENT_ID
        ...
        Public Overrides Sub UpdateDisplay()
            ...
            Me._bizAgent.DoRequest(Business.B_03_01201.Affairs.LoadList, False)
...
#Region"Private Methods"
        ...
        Private Sub DoPrivateUpdateSelectingRow()
            ...
            If Me.GridView_ClientPointIO.RowCount > 0 Then
                Me.SVFR_SELECTING_ROW = _
                    CType(Me.GridView_ClientPointIO.GetDataRow( _
                        Me.GridView_ClientPointIO.FocusedRowHandle),  _
                        MyPosXAuto.FTs.FT_H_MP_CLIENT_POINT_IORow)
...
#End Region
        ...
        Private Sub ButtonEdit_ClientCode_ButtonClick(ByVal sender As Object, ByVal e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs) Handles ButtonEdit_ClientCode.ButtonClick
            Dim inputForm As New M_01_00801(Me.TransactRequestHandle, Me.FormID)
            inputForm.LAUNCH_CONDITION = MyPosXService.S_01_00801.LCs.Choose
            Me.PopupForm(inputForm, "ButtonEdit_ClientCode_ButtonClick", False)
        End Sub

        Private Sub GridView_ClientPointIO_FocusedRowChanged(ByVal sender As Object, ByVal e As DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs) Handles GridView_ClientPointIO.FocusedRowChanged
            Me.DoPrivateUpdateSelectingRow()

        End Sub

        Private Sub ButtonEdit_ClientCode_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles ButtonEdit_ClientCode.KeyDown
            If e.KeyCode = Keys.Enter Then
                Me._bizAgent.DoRequest(Business.B_03_01201.Affairs.LoadClientInfoByCode, False)
            End If
        End Sub
    End Class
